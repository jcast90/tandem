...
server.registerTool(
  "tandem_room_create",
  {
    ...
    description:
      "Start a general deliberation or five-round Problem Discovery Room before a separate chair synthesis across configured CLI profiles. Use profile local-muse-glimmer for the local Ollama muse-glimmer model.",
    inputSchema: {
