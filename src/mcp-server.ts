...
server.registerTool(
  "tandem_room_create",
  {
    ...
    description:
      "Start a general or purpose-specific five-round deliberation before a separate chair synthesis across configured CLI profiles. Presets: problem-discovery, decision, architecture, red-team, research, and execution-planning. Use profile local-muse-glimmer for the local Ollama model.",
    inputSchema: {
